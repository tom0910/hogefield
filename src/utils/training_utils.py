...
def train_as_hypp_change(
    ...
    #loads checkpoint data or if not trained yet it returns: None, 0, [], [], 0
    checkpoint, start_epoch, loss_hist, acc_hist, counter = FT.load_checkpoint(pth_file_path=pth_file_path, model=model, optimizer=optimizer)
