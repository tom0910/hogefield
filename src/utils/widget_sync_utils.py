...
def set_mel_config_from_widget_values(mel_config, n_fft_input, hop_length_slider, n_mels_slider, f_min_slider, f_max_slider, power_toggle, filter_choice_widget , mel_filter_plot_radio_widget):
    ...
    mel_config.update_from_widgets(
        ...
        filter_type=filter_choice_widget.get(),
        toggle_mel_filter= mel_filter_plot_radio_widget.get()
    )
